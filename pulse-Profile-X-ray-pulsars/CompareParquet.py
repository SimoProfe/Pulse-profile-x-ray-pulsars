...
## the experimental data, in order to find the simulated set of parameters that best suits
...
def storeVariables(filepath):
    ...
    Returns:
        ---
        param1, param2, param3, rot_i, rot_a, magnc, shift: all the parameters that define the best-fitting simulated hotspot pattern
...
#param1, param2, param3, rot_i, rot_a, magnc, shift = storeVariables("C:\\Users\\Utente\\Downloads\\ParquetColab")
